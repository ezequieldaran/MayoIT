...
if ($action == 'ajax') {
    ...
    $aColumns = array('name', 'email');  // Columnas de búsqueda
    $sTable = "user";
    $sWhere = "";
    if ($_GET['q'] != "") {
        $sWhere = "WHERE (";
    ...
    // Contar el total de filas en tu tabla
    ...
    // Bucle a través de los datos recuperados
    if ($numrows > 0) {
        ?>
        <table class="table table-striped jambo_table bulk_action">
            <thead>
                <tr class="headings">
                    ...
                    <th class="column-title">DNI/CUIL </th>
            ...
            while ($r = mysqli_fetch_array($query)) {
                ...
                <input type="hidden" value="<?php echo $cuil_dni; ?>" id="cuil_dni<?php echo $id; ?>">

                <tr class="even pointer">
                    <td><?php echo $name; ?></td>
                    <td><?php echo $email; ?></td>
                    <td><?php echo $direccion; ?></td>
                    <td><?php echo $cuil_dni; ?></td>
