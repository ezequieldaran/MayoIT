<?php
    ...
    if (isset($_GET['id'])){
        ...
        $query=mysqli_query($con, "SELECT * from presupuestos where id='".$id_del."'");
        $count=mysqli_num_rows($query);

            if ($delete1=mysqli_query($con,"DELETE FROM presupuestos WHERE id='".$id_del."'")){
?>
    ...
    if($action == 'ajax'){
        ...
        $sWhere.=" order by creado_at desc";
        ...
        if ($numrows>0){
            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                <tbody>
                    ...
                    <?php 
                        ...
                        while ($r=mysqli_fetch_array($query)) {
                            ...
                            $precio=$r['precio'];
                            $creado_at=date('d/m/Y', strtotime($r['creado_at']));
                            
                        
                            $sql = mysqli_query($con, "select * from presupuestos where id=$id ");
                ...
                ?>
                    ...
                    <input type="hidden" value="<?php echo $creado_at;?>" id="creado_at<?php echo $id;?>">
