            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li class="<?php if(isset($active3)){echo $active3;}?>">
                        <a href="projects.php"><i class="fa fa-list-alt"></i> Sucursal</a>
                    </li>
                    ...
                    <li class="<?php if(isset($active6)){echo $active6;}?>">
                        <a href="users.php"><i class="fa fa-users"></i> Clientes </a>
                    </li>
                    
                     <li class="<?php if(isset($active7)){echo $active7;}?>">
                        <a href="presupuestos.php"><i class="fa fa-money"></i> Presupuestos </a>
                    </li>
