    ...
    <div class="right_col" role="main"><!-- page content -->
        ...
        <div class="x_content">
            ...
            foreach($users as $user){
                ...
                $status=mysqli_query($con, "select * from status where id=$status_id");        //estado
                $category=mysqli_query($con, "select * from category where id=$category_id");  //pc impresora
                $kinds = mysqli_query($con,"select * from kind where id=$kind_id");            //tipo de ticket
                $project  = mysqli_query($con, "select * from project where id=$project_id");  //sucursal
                $priority = mysqli_query($con,"select * from priority where id=$priority_id"); //prioridad
                ...
                <?php } ?>
                <?php foreach($priority as $prioritys){?>
                <td><?php echo $prioritys['name']; ?></td>
                <?php } ?>
