...
function obtener_datos(id){
    ...
    var direccion = $("#direccion"+id).val();  // Agregamos dirección
    var cuil_dni = $("#cuil_dni"+id).val();  // Agregamos CUIL/DNI
    $("#mod_id").val(id);
    $("#mod_name").val(name);
    $("#mod_email").val(email);
    $("#mod_status").val(status);
    $("#mod_direccion").val(direccion); // Cargar dirección en el modal
    $("#mod_cuil_dni").val(cuil_dni); // Cargar CUIL/DNI en el modal
}
