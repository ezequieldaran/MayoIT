<?php 
    ...
    $PresupuestoData=mysqli_query($con, "select * from presupuestos");
                ...
                <div class="row top_tiles">
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <h3><a href="./tickets.php">Tickets Pendientes</a></h3>
                        </div>
                    </div>
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <div class="count"><?php echo mysqli_num_rows($PresupuestoData) ?></div>
                          <h3><a href="./presupuestos.php">Presupuestos</a></h3>
                        </div>
                    </div>
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <h3><a href="./users.php">Clientes</a></h3>
                        </div>
                    </div>
